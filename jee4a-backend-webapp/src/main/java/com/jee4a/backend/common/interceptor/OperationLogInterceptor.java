 ...
 * @date 2018年3月10日
 */
public class OperationLogInterceptor extends AbstractBaseController implements HandlerInterceptor {

	ThreadLocal<Long> startTime = new ThreadLocal<>();

	protected SysOperationLogManager sysOperationLogManager;
	...
	public void afterCompletion(HttpServletRequest arg0, HttpServletResponse arg1, Object arg2, Exception arg3)
		...
		try {
			if (arg2 instanceof HandlerMethod) {
				...
				OperationLogAnnotation methodAnnotation = handlerMethod
						.getMethodAnnotation(OperationLogAnnotation.class);
