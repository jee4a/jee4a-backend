...
public class DateUtils  extends org.apache.commons.lang.time.DateUtils{
	...
	public static final String BASE_START_TIME = "2018-06-28 18:00:00";
...
//	}
	...
	*/
	...
	public static int getIntervalsEndTime() {
		Date now = new Date();
		Date e = getDayEnd(now);
		long a = new Date().getTime();
		long b = e.getTime();
		int c = (int)((b - a) / 1000);
		return c;
	}
	public static String[] getParamDate(String starTime,String endTime) {
		int startLength = 0;
		int endLength = 0;
		if(StringUtils.isEmpty(starTime) && !StringUtils.isEmpty(endTime)) {
			endLength = endTime.length();
		}
		if(StringUtils.isEmpty(endTime) && !StringUtils.isEmpty(starTime)) {
			startLength = starTime.length();
		}
		if(!StringUtils.isEmpty(endTime) && !StringUtils.isEmpty(starTime)) {
			startLength = starTime.length();
			endLength = endTime.length();
		...
		return new String[] {starTime,endTime};
	}
}
