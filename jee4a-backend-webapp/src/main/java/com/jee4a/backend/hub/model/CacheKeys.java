package com.jee4a.backend.hub.model;
...
import com.jee4a.common.io.cache.CacheKey;
...
public class CacheKeys {
	...
	private static final String GLOBEL_KEY = "crm_";
	 ...
	 * 菜单信息
	 */
	public static final CacheKey KEY_SYS_RESOURCE_ID = build("sys_resource_id_", CacheKey.MINUTES1);

	/**
	 * 
	 */
	public static final CacheKey KEY_USER_LOGIN_INFO = build("user_login_info_", CacheKey.HOUR12);
	/**
	 * 检查cachekeys是否存在重复定义
	 */
	static {
